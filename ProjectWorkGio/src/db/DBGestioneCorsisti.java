...
public class DBGestioneCorsisti{
	...
	public ArrayList<Formazione> selectFormazioneCorsisti(RicercaScelta ricercaScelta) throws SQLException
	{
		...
		while(result.next())
		{
			...
			formazione.setIdFormazione(result.getInt(1));
	...
	public ArrayList<Certificazione> selectCertificazioniDaCompetenze(String competenza) throws SQLException
	{
	...
	public ArrayList<Certificazione> selectCertificazioniDaCertificazione(Certificazione certificazioneQuery) throws SQLException
	{
		ArrayList<Certificazione>listCertificazioni = new ArrayList<>();
		String sql = "select ce.* "
				+ "from anagraficaCandidato ac, candidato c, cv cv, certificazione ce "
