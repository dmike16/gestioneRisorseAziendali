...
insert into Corso values ('AKT000C', 'Corso Analista Programmatore Java-Oracle', (TO_DATE ('2016-GEN-07', 'yyyy-mon-dd')), (TO_DATE ('2016-MAR-17', 'yyyy-mon-dd')), 'AKT S.r.l','informatica','java' );
insert into Corso values ('AKT001C', 'Corso Sistemista', (TO_DATE ('2016-MAR-01', 'yyyy-mon-dd')), (TO_DATE ('2016-MAG-01', 'yyyy-mon-dd')), 'AKT S.r.l', 'informatica','sistemi');
insert into Corso values ('AKT002C', 'Corso Sviluppatore Android', (TO_DATE ('2015-SET-07', 'yyyy-mon-dd')), (TO_DATE ('2015-NOV-17', 'yyyy-mon-dd')), 'AKT S.r.l', 'informatica','android');
