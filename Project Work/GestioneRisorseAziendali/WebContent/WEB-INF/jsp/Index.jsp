...
<body>
    ...
    <div class="container-fluid">
        ...
        <!--Inizio corsisti-->
        <a href="gestioneCorsisti.action">
            <div id="corsisti" class="row">
                <div class="col-xs-12">
                    <p>Gestione Corsisti</p>
                </div>
            </div>
        </a> <!--Fine corsisti-->
        <!--Inizio selezione-->
        <a href="gestioneSelezione.action">
            <div id="selezione" class="row">
                <div class="col-xs-12">
                    <p>Gestione selezioni</p>
                </div>
            </div> <!--Fine selezione-->
        </a><!--Inizio anagrafica-->
    </div><!--container end-->
